include("includes/bridge_cmn_opendb.inc");
	...
	$job_mailmessage="Test Email"
	// To send an email call the below function:
		$from= $job_mailfrom;
		$mail_result = $objdb_function->dosendemail($job_mailfrom,$job_mailto,$job_mailsubject,$job_mailmessage);
